	...
	return (
		<section className="ethemeralsBg privacyPolicy px-4 pb-24 mx-auto sm:pb-16 sm:px-6 lg:px-8 xl:pb-32 leading-loose">
			<div className="mx-auto p-4 z-10 pb-10 md:pb-20 max-w-5xl ">
				<h1 className="text-7xl font-medium pt-20 md:pt-40 font-ubuntu">Privacy Policy</h1>
				...
				<h2 className="text-xl pt-5">Interpretation</h2>
				<p>
				...
				<h2 className="text-xl pt-5">Definitions</h2>
				...
				<ul>
					...
					<li>
						<p>
							<strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Kingdom Of The Ethemerals.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to Kingdom Of The Ethemerals, accessible from{' '}
							<a href="ethemerals.com" rel="external nofollow noopener" target="_blank">
								ethemerals.com
							</a>
						</p>
					</li>
				...
				<h2 className="text-xl pt-5">Types of Data Collected</h2>
				<h3 className="text-lg pt-5">Personal Data</h3>
				<p>
				...
				<h3 className="text-lg pt-5">Usage Data</h3>
				...
				<h3 className="text-lg pt-5">Tracking Technologies and Cookies</h3>
				<p>
				...
				<h2 className="text-xl pt-5">Use of Your Personal Data</h2>
				...
				<h2 className="text-xl pt-5">Retention of Your Personal Data</h2>
				<p>
				...
				<h2 className="text-xl pt-5">Transfer of Your Personal Data</h2>
				<p>
				...
				<h2 className="text-xl pt-5">Disclosure of Your Personal Data</h2>
				<h3 className="text-lg pt-5">Business Transactions</h3>
				<p>
				...
				<h3 className="text-lg pt-5">Law enforcement</h3>
				<p>
				...
				<h3 className="text-lg pt-5">Other legal requirements</h3>
				...
				<h2 className="text-xl pt-5">Security of Your Personal Data</h2>
				<p>
				...
				<ul>
					<li>By email: contact@ethemerals.com</li>
				</ul>
			</div>
		</section>
	);
