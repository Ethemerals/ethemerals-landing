	...
	return (
		<section className="ethemeralsBg privacyPolicy px-4 pb-24 mx-auto sm:pb-16 sm:px-6 lg:px-8 xl:pb-32 leading-loose">
			<div className="mx-auto p-4 z-10 pb-10 md:pb-20 max-w-5xl ">
				<a id="battle">
					<h2 className="text-6xl font-medium pt-20 md:pt-40 font-ubuntu">Terms & Conditions</h2>
				</a>

				<p>Welcome to Kingdom of the Ethemerals!</p>

				<p>These terms and conditions outline the rules and regulations for the use of Kingdom of the Ethemerals Website, located at ethemerals.com.</p>

				<p>
					By accessing this website we assume you accept these terms and conditions. Do not continue to use Kingdom of the Ethemerals if you do not agree to take all of the terms and conditions stated
					on this page.
				</p>
				...
				<p>We employ the use of cookies. By accessing Kingdom of the Ethemerals, you agreed to use cookies in agreement with the ethemerals.com's Privacy Policy. </p>
				...
				<p>
					Unless otherwise stated, ethemerals.com and/or its licensors own the intellectual property rights for all material on Kingdom of the Ethemerals. All intellectual property rights are
					reserved. You may access this from Kingdom of the Ethemerals for your own personal use subjected to restrictions set in these terms and conditions.
				</p>

				<p>You must not:</p>
				<ul>
					<li>Republish material from Kingdom of the Ethemerals</li>
					<li>Rent or sub-license material from Kingdom of the Ethemerals</li>
					<li>Reproduce, duplicate or copy material from Kingdom of the Ethemerals</li>
				</ul>

				<p>This Agreement shall begin on the date hereof.</p>

				<p>
					Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. ethemerals.com does not filter, edit, publish or review
					Comments prior to their presence on the website. Comments do not reflect the views and opinions of ethemerals.com,its agents and/or affiliates. Comments reflect the views and opinions of the
					person who post their views and opinions. To the extent permitted by applicable laws, ethemerals.com shall not be liable for the Comments or for any liability, damages or expenses caused
					and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
				</p>

				<p>ethemerals.com reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>
				...
				<p>
					You hereby grant ethemerals.com a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.
				</p>
				...
				<p>
					...
					does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of ethemerals.com; and (d) the link is in the context of
				...
				<p>
					If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to ethemerals.com. Please include your
				...
				<p>No use of ethemerals.com's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
				...
				<p>
					We shall not be hold responsible for any content that appears on your Website. You agree to protect and defend us against all claims that is rising on your Website. No link(s) should appear
