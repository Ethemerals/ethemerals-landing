...
const Footer = () => {
  return (
    <footer className="titleBg pb-8 xs:pt-8 md:pt-12 xl:pt-16">
        <div className="max-w-screen-lg mx-auto px-4 sm:px-6 md:px-8 text-gray-400 ">
            <ul className="text-lg font-light pb-8 flex flex-wrap justify-center">
                <li className="w-1/2 md:w-1/3 lg:w-1/3">
                    <div className="text-center">
                        <h2 className=" text-gray-200 text-md uppercase mb-4">
                            Quick Links
                        </h2>
                        <ul>
          ...
          <div className="pt-8 flex border-t border-gray-200 max-w-xs mx-auto items-center justify-center gap-x-9 lg:border-none">
            <a href="#">
