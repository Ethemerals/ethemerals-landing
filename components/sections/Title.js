			...
			<div className="container mx-auto px-4 md:px-12 relative z-10 flex items-center xs:pt-12 sm:pt-20 md:pt-32 xl:py-40">
				<div className="xl:w-4/5 lg:w-3/5 flex flex-col items-start relative z-10 pt-12 sm:pt-0">
					...
					<div className="flex items-center space-x-5 py-3 lg:mb-12">
						<a href="#">
							<svg fill="white" className="text-xl w-6 h-6 hover:text-white transition-colors duration-200" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
								<path d="M1684 408q-67 98-162 167 1 14 1 42 0 130-38 259.5t-115.5 248.5-184.5 210.5-258 146-323 54.5q-271 0-496-145 35 4 78 4 225 0 401-138-105-2-188-64.5t-114-159.5q33 5 61 5 43 0 85-11-112-23-185.5-111.5t-73.5-205.5v-4q68 38 146 41-66-44-105-115t-39-154q0-88 44-163 121 149 294.5 238.5t371.5 99.5q-8-38-8-74 0-134 94.5-228.5t228.5-94.5q140 0 236 102 109-21 205-78-37 115-142 178 93-10 186-50z"></path>
							</svg>
						</a>
						<a href="#">
							<svg className="text-xl w-6 h-6 hover:text-white transition-colors duration-200" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 245 240">
								<path
									class="st0"
						...
						<a href="#">
							<svg className="text-xl w-6 h-6 hover:text-white transition-colors duration-200" xmlns="http://www.w3.org/2000/svg">
								<path
									d="M59.158 53.002L64 57.677v.155H39.44v-.155l4.93-4.675c.526-.433.778-1.12.657-1.795V21.322c0-1.263 0-2.97.22-4.43L28.68 58.43h-.197L11.328 20.214l-.723-1.662V43.61a8.79 8.79 0 0 0 .811 4.896l6.902 9.172v.155H0v-.155l6.902-9.194c.73-1.512 1-3.204.81-4.874V15.916c.112-1.364-.295-2.72-1.14-3.788L1.687 5.725V5.57h17.528l14.68 32.368L46.822 5.57h17.156v.155l-4.82 5.428c-.578.427-.866 1.148-.745 1.86v38.194a1.78 1.78 0 0 0 .745 1.795z"
									fill="white"
								/>
							</svg>
						</a>
