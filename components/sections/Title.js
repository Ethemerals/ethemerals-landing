				...
				<div className="flex flex-col items-start relative z-10 md:w-3/4 xl:w-4/5 lg:w-3/5 md:-mt-20">
					...
					<div className="flex items-center space-x-5 py-4 lg:mb-8 text-gray-100">
						...
						<a href={Links.DISCORD} target="_blank" className="hover:text-white">
							<svg width="28" height="28" viewBox="0 0 201 144" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
						...
						<a href={Links.GITHUB} target="_blank" className="hover:text-white">
							<svg width="26" height="26" viewBox="0 0 181 177" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
