	...
	return (
		<section className="bg-gray-200 px-4 pb-12 mx-auto sm:pb-16 sm:px-6 lg:px-8 xl:pb-32">
			<div className="max-w-4xl mx-auto text-center">
				<a id="community">
					<h2 className="text-center xs:text-4xl md:text-7xl pt-16 md:pt-20 text-black">Community</h2>
				</a>
			...
			<div className="text-center md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-2 lg:gap-x-8 sm:grid lg:max-w-7xl m-auto">
				<div className="shadow-lg  bg-white xs:w-9/12 lg:w-full m-auto my-4">
					<img src={img4} className=" mx-auto justify-center w-50 h-50" />
				</div>
				<div className="shadow-lg  bg-white xs:w-9/12 lg:w-full m-auto my-4">
					<img src={img3} className=" mx-auto justify-center w-50 h-50" />
				</div>
				<div className="shadow-lg  bg-white xs:w-9/12 lg:w-full m-auto my-4">
					<img src={img2} className=" mx-auto justify-center w-50 h-50" />
				</div>
				<div className="shadow-lg  bg-white xs:w-9/12 lg:w-full m-auto my-4">
					<img src={img1} className=" mx-auto justify-center w-50 h-50" />
				</div>
			</div>
